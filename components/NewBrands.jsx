...
import { extractReviewBonus, extractReviewImage, extractLink, extractBadge, extractPros } from "./brandUtils";
      ...
      <div className="main__container pb-6">
        ...
        <div className="flex flex-col px-0 py-6">
          {filteredBrands.map((brand) => {
            ...
            return (
              <div className="flex flex-wrap mb-2 card-brand-new" key={brand.id}>
                <div className="brandImage p-3">
                  ...
                  <Link className="flex basis-[13%] items-center p-3" key={brand.id} href={`/bonuses/${brand.id}`}>
                  ...
                  />
                   <div className="flex basis-[25%] items-center ml-3"
                    dangerouslySetInnerHTML={{
